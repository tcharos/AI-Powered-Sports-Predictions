...
python3 ml_project/nba/fetch_nba_stats_tables.py
if [ $? -ne 0 ]; then
...
python3 ml_project/nba/fetch_nba_history_stats.py
if [ $? -ne 0 ]; then
...
python3 ml_project/nba/nba_feature_engineering.py
if [ $? -ne 0 ]; then
...
python3 ml_project/nba/train_nba_models.py
if [ $? -ne 0 ]; then
